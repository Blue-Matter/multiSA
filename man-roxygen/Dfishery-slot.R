...
#' \item{`sel_f`}{Character vector of the functional form for selectivity for each fleet. See `type` argument in [conv_selpar()] for all options, for example, `"logistic_length", "dome_length", "logistic_age", "dome_age", "total", "mature"`}
