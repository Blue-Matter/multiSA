...
vars$Number <- paste0("1.", 1:nrow(vars))
knitr::kable(vars)
```
...
dyn_input$Number <- paste0("2.", 1:nrow(dyn_input))
...
param$Number <- paste0("3.", 1:nrow(param))
knitr::kable(param)
```
...
param2$Number <- paste0("4.", 1:nrow(param2))
knitr::kable(param2)
```
...
pop_dyn$Number <- paste0("5.", 1:nrow(pop_dyn))
knitr::kable(pop_dyn)
```
...
report_var$Number <- paste0("6.", 1:nrow(report_var))
...
like$Number <- paste0("7.", 1:nrow(like))
knitr::kable(like)
```
...
For lognormal and logitnormal likelihoods, $\sigma$ is a user-provided variance term.
...
like_comp$Number <- paste0("8.", 1:nrow(like_comp))
