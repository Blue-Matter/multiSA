...
- [`residuals(`*`<MSAassess>`*`)`](https://blue-matter.github.io/multiSA/reference/residuals.md)
...
- [`simulate(`*`<MSAassess>`*`)`](https://blue-matter.github.io/multiSA/reference/simulate.md)
  : Simulate data
- [`summary(`*`<MSAassess>`*`)`](https://blue-matter.github.io/multiSA/reference/summary.md)
